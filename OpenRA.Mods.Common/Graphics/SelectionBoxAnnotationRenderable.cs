...
namespace OpenRA.Mods.Common.Graphics
{
	public class SelectionBoxAnnotationRenderable : IRenderable, IFinalizedRenderable
	{
		...
		public void Render(WorldRenderer wr)
		{
			...
			cr.DrawScreenLine(new float3[] { tl + u, tl, tl + v }, 1, color, true);
			cr.DrawScreenLine(new float3[] { tr - u, tr, tr + v }, 1, color, true);
			cr.DrawScreenLine(new float3[] { br - u, br, br - v }, 1, color, true);
			cr.DrawScreenLine(new float3[] { bl + u, bl, bl - v }, 1, color, true);
		}
