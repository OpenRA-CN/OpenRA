...
namespace OpenRA.Mods.Common.Graphics
{
	...
	public class DefaultSpriteSequence : ISpriteSequence
	{
		...
		[Desc("Sprite mesh type, which will finally replace DepthSprite")]
		static readonly SpriteSequenceField<SpriteMeshType> MeshType = new SpriteSequenceField<SpriteMeshType>(nameof(MeshType), SpriteMeshType.Card);
		SpriteMeshType ISpriteSequence.MeshType => meshType;
		...
		public DefaultSpriteSequence(ModData modData, string tileSet, SpriteCache cache, ISpriteSequenceLoader loader, string image, string sequence, MiniYaml data, MiniYaml defaults)
		{
			...
			meshType = LoadField(MeshType, data, defaults);
