...
namespace OpenRA.Mods.Common.Projectiles
{
	...
	public class LaserZap : IProjectile, ISync
	{
		...
		public void Tick(World world)
		{
			...
			if (info.Blockable && BlocksProjectiles.AnyBlockingActorsBetween(world, args.SourceActor.Owner, source, target, info.Width, out var blockedPos, out blocker, args))
			{
				target = blockedPos;
			}
