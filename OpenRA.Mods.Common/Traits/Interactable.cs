...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class InteractableInfo : ConditionalTraitInfo, IMouseBoundsInfo
	{
	...
	public class Interactable : ConditionalTrait<InteractableInfo>, INotifyCreated, IMouseBounds
	{
