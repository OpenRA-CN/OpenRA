...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class PlayerResources : ISync
	{
		...
		public void GiveSpecialRawResources(int count, string rtype)
		{
			Dictionary<string, int> allUsage;
			if (Info.SpecialResourceValues.TryGetValue(rtype, out allUsage))
			{
		...
		public bool CanAcceptSpecialRawResources(string rtype)
		{
			return Info.SpecialResourceValues.ContainsKey(rtype);
		}
