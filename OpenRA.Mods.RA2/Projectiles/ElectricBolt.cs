...
namespace OpenRA.Mods.RA2.Projectiles
{
	...
	public class ElectricBoltInfo : IProjectileInfo
	{
		...
		public readonly string LaunchEffectImage = "effects";
	...
	public class ElectricBolt : IProjectile, ISync
	{
		...
		readonly HashSet<(Color, WPos[])> zaps;
		...
		public ElectricBolt(ElectricBoltInfo info, ProjectileArgs args)
		{
			...
			hasLaunchEffect = !string.IsNullOrEmpty(info.LaunchEffectSequence);
		...
		public IEnumerable<IRenderable> Render(WorldRenderer wr)
		{
			...
			if (ticks < info.Duration)
			{
				foreach (var zap in zaps)
				{
					...
					yield return new ElectricBoltRenderable(offsets, info.ZOffset, info.Width, zap.Item1);
				}
			}
		}
	}
